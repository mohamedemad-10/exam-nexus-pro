...
import { Brain, ArrowLeft, Mail, Phone, MapPin, Send, Loader2, LogOut, Home, LayoutDashboard } from "lucide-react";
      ...
      <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-12 max-w-6xl">
        ...
        {isLoggedIn && userName && (
          <motion.div
            ...
            className="mb-6 p-4 glass-card border-primary/30 rounded-xl"
          >
            <p className="text-sm sm:text-base text-muted-foreground">
              Hello, <span className="text-primary font-medium">{userName}</span>! We're here to help.
            </p>
          </motion.div>
        )}
        ...
        >
          <h2 className="text-2xl sm:text-4xl font-display gradient-text mb-2 sm:mb-4">Contact Us</h2>
          <p className="text-sm sm:text-base text-muted-foreground">
          ...
          >
            <Card className="glass-card border-primary/20">
              <CardHeader className="p-4 sm:p-6">
                <CardTitle className="font-display text-lg sm:text-xl">Send us a message</CardTitle>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                        className="bg-background/50 h-10 sm:h-11 text-sm"
          ...
          >
              ...
              <CardContent className="p-4 sm:p-5">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div className="min-w-0">
                    <h3 className="font-display text-sm sm:text-lg mb-1">Email</h3>
            ...
            <Card className="glass-card border-secondary/20">
              <CardContent className="p-4 sm:p-5">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-sm sm:text-lg mb-1">Phone</h3>
            ...
            <Card className="glass-card border-secondary/20">
              <CardContent className="p-4 sm:p-5">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    <h3 className="font-display text-sm sm:text-lg mb-1">Address</h3>
            ...
            <Card className="glass-card border-primary/30">
              <CardContent className="p-4 sm:p-5 text-center">
                ...
                <h3 className="font-display text-base sm:text-lg mb-2">Need immediate help?</h3>
